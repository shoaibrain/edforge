...
* **2.5 Historical Reports:** The [Flash I Report 2081 (2024/25)](https://giwmscdnone.gov.np/media/pdf_upload/Flash%201%20Report%202081%20Final_rn76ynj.pdf) reveals the implied schema: distinct tables for age-wise enrollment, caste (Dalit, Janajati), disabilities (physical, visual, auditory, intellectual), and teacher qualifications. ⚠️ A second citation (`opendatanepal.com/datasets/flash-i-report-2080-2023-24`) appeared in the original Gemini search output but **was confirmed dead/hallucinated during v3.4 spot-check on 2026-05-22** — the URL resolves to the OpenDataNepal portal homepage, not a Flash I 2080 dataset page. The single Flash I 2081 PDF citation above suffices to establish the schema; a verified alternate Flash 2080 source can be added if needed.
