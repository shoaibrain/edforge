...
- **Sprints fully shipped + validated (🟢):** 9 — 0.4, A.2, A.3, A.4, **D.2** (shipped 2026-05-24), **D.3** (shipped 2026-05-24), E.0, E.1, **C.0** (shipped 2026-05-25, closed end-to-end 2026-05-25 PM via [C.0-followup #195](https://github.com/shoaibrain/edforge/pull/195))
- **Sprints partially shipped (🟡, with documented gaps):** 3 — 0.1 (0.1.3 reclassified to E.1.5 per §17.6), D.1 (R38 mapper serializer followup), **C.1 (C.1.1 shipped 2026-05-25 PM; C.1.2–C.1.6 next)**. C.0 — previously 🟡 with 2 HIGH followups — is now 🟢 in the table above; C.0-followup [PR #195](https://github.com/shoaibrain/edforge/pull/195) closed the 2 HIGH gaps + 1 MEDIUM test debt end-to-end on 2026-05-25 PM.
